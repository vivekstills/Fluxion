...
const TraderCardComponent = ({
  ...
  const placeholder = PlaceHolderImages.find(p => p.id === trader.image) as ImagePlaceholder;
  const avatarUrl = placeholder?.imageUrl ?? '';
          ...
          <div className="pc-content">
            <div className="pc-details">
                <div className='flex w-full items-center justify-between px-8'>
                    <h3>{trader.name}</h3>
                    <Badge className={cn(trader.tierColor, "border-none text-lg")}>{trader.tier}</Badge>
                </div>
              <p>ELO: {trader.elo}</p>
            </div>
          </div>
...
export const TraderCard = React.memo(TraderCardComponent);
